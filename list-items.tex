...
\begin{document}
	...
	\subsection{A (4 aktorra) kiterjesztett relatív protokollfüggvény}

	A $q$ paraméter (eddig megtett menetszám) felvehető értéki szintén kibővültek: már ,,negyedes'' (4-es nevezőjű) törtértékeket is fölvehet. Ennek indítéka, hogy e ,,kísértetállomás''-szabályt be lehessen illeszteni az alábbiakban megadandó \emph{kibővített} relatív protokollfüggvény definíciójába:
